...
def overview_df(media_df, ga_df, metric_set, trans_metric_set, group_period, condition_set, period_set):
    ...
    unsel_media_trans_set = set(metric_set['trans_metric']) - set(trans_metric_set['selected_trans_media'])
    unsel_ga_trans_set = set(metric_set['trans_ga_metric']) - set(trans_metric_set['selected_trans_ga'])
