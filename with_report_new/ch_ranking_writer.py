...
from with_report_new.grouping import grouped_media_with, grouped_ga_with
from with_report_new.reporting import report_media, report_ga, report_ga_add
from with_report_new.diff import comparing_df
from with_report_new.rounding import round_two_axis, round_col_axis, round_multi_axis
...
def ch_ranking_df(media_df, ga_df, col_name, metric_set, trans_metric_set,pr_trans_metric_set, group_period, condition_set):
    ...
    col_list = rounded_ch_ranking_df.columns.to_list()
    ...
    rounded_overview_df_filtered = rounded_ch_ranking_df.drop(columns=filter_trans)

    return rounded_ch_ranking_df, rounded_overview_df_filtered, col_list
...
def ch_df(ch_ranking_df, col_name, col_value,metric_set,pr_trans_metric_set, group_period, period_set, condition_set):
    ...
    rounded_overview_ch_df_filtered = rounded_overview_ch_df.drop(columns=filter_trans)

    return rounded_overview_ch_df, rounded_overview_ch_df_filtered
